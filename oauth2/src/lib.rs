use oauth2::reqwest::{self, async_http_client};
use oauth2::{
    basic::BasicClient, basic::BasicErrorResponseType, url::Url, AccessToken,
    AsyncClientCredentialsTokenRequest, AuthUrl, ClientId, ClientSecret, RedirectUrl,
...
impl AppAccessToken {
    ...
    pub async fn from_existing(
        ...
        Ok(Self::from_existing_unchecked(token.secret().to_owned(), validated.client_id, None, validated.scopes))
    }
