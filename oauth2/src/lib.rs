...
#![deny(missing_docs)]
#![doc(html_root_url = "https://docs.rs/twitch_oauth2/0.3.1")]
//! [![github]](https://github.com/emilgardis/twitch_utils)&ensp;[![crates-io]](https://crates.io/crates/twitch_oauth2)&ensp;[![docs-rs]](https://docs.rs/twitch_oauth2/0.3.1/twitch_oauth2)
//!
...
use oauth2::{
    ...
    ExtraTokenFields, RequestTokenError, TokenResponse, TokenType,
};
...
impl TwitchToken for AppAccessToken {
    ...
    async fn refresh_token(&mut self) -> Result<(), RefreshTokenError> {
        ...
        {
            refresh_token(token, &self.client_id, &self.client_secret).await?
        } else {
...
impl AppAccessToken {
    ...
    pub async fn from_existing(
        access_token: AccessToken,
        client_secret: ClientSecret,
    ) -> Result<AppAccessToken, ValidationError>
    {
